#!/usr/bin/env bash
python ./main/test.py --config 'experiments/siamfcpp/test/vot/siamfcpp_alexnet.yaml'
python ./main/test.py --config 'experiments/siamfcpp/test/vot/siamfcpp_googlenet.yaml'
python ./main/test.py --config 'experiments/siamfcpp/test/vot/siamfcpp_tinyconv.yaml'
